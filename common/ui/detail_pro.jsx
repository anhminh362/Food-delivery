      ...
      <ScrollView>
        <View style={styles.detail_text}>
          ...
          <Text style={styles.text_desc}>
            Rainbow Sandwich Sugarless Nulla occaecat velit laborum exercitation
            ullamco. Elit labore eu aute elit nostrud culpa velit excepteur
            deserunt sunt. Velit non est cillum consequat cupidatat ex Lorem
