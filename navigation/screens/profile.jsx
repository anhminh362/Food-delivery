      ...
      <ScrollView >
        <View style={styles.detail_text}>
          ...
          <View style={{ flexDirection: 'row', }}>
            ...
            <Ionicons name='pencil' color={"#6B50F6"} size={22} style={{ marginTop: 7, marginLeft: 130, }}></Ionicons>
          </View>
          <Text style={{ color: '#D2D2D4', marginLeft: 25, fontSize: 17, }}>awdesign.ar@gmail.com</Text>
          <View style={styles.voucher}>
            <Image style={styles.image_voucher}
              source={require(`../../assets/images/voucher1.jpg`)} />
            <Text style={{ fontSize: 14, marginTop: 15, marginLeft: 30, }}>You Have 3 Voucher</Text>
          </View>
          <Text style={{
            fontSize: 16,
            fontWeight: 'bold',
